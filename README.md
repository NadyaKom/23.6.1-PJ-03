...
4. <имя валюты> <имя валюты в которой надо узнать цену первой валюты> <количество первой валюты> выводит значение количества валюты в которой надо узнать цену первой валюты.
